    ...
    <div class="container" data-layout="container">
        ...
        <div class="content">
            ...
            <div class="card-header  text-white">
                <h3 class="mb-0">Directorio de clientes</h3>
            </div>
            <div id="tableExample3" data-list='{"valueNames":["nombre","app","pais","estado","dieccion","telefono"],"page":10,"pagination":true}'>
                    ...
                    <table class="table table-bordered table-striped fs-10 mb-0">
                        <thead class="bg-300">
                            <tr>
                                ...
                                <th class="text-900 sort" data-sort="dereccion">Direecion</th>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="align-middle white-space-nowrap nombre">
                                            <a href="infoclient.php?idCliente=<?php echo htmlspecialchars($cliente['idCliente']); ?>">
                                                <?php echo htmlspecialchars($cliente['nombreCliente'] . ' ' . $cliente['apellidoPaterno']); ?>
                                            </a>
                                        </td>


                                        <td class="align-middle white-space-nowrap pais"><?php echo htmlspecialchars($cliente['pais']); ?></td>
                                        <td class="estado"><?php echo htmlspecialchars($cliente['estado']); ?></td>
                                        <td class="direccion"><?php echo htmlspecialchars($cliente['direccion']); ?></td>
                                        <td class="telefono"><?php echo htmlspecialchars($cliente['telefono']); ?></td>

...
require_once '../falcon-main1/public/controller/consultas.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    ...
    // Llama a la función de inicio de sesión desde login.php
    if (login($email, $password)) {
        // Inicio de sesión exitoso, redirigir a la página de bienvenida o dashboard
        header("Location: management.php");
        exit();
    } else {
        // Inicio de sesión fallido, mostrar mensaje de error o redirigir de nuevo a la página de inicio de sesión

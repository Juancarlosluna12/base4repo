...
if ($idProveedor) {
    ...
    $Proveedor = obtenerProveedorPorId($idProveedor);

    // Verificar si hay resultados
    if (!$Proveedor) {
        // Mensaje de alerta si no hay contactos
        $mensaje = '<div class="alert alert-danger" role="alert">
                      <h4 class="alert-heading fw-semi-bold">Proveedor sin contactos</h4>
                      <p>El Proveedor no tiene contactos registrados.</p>
                      <hr />
                      <p class="mb-0">Aún no se han registrado contactos para este Proveedor.</p>
                    </div>';
    }
} else {
    // Redirigir a error.php si no se proporciona idProveedor
                        ...
                        <table class="table table-bordered table-striped fs-10 mb-0">
                            <thead class="bg-300">
                                <tr>
                                    ...
                                    <th class="text-900 sort" data-sort="horaAtencionSemana">HS ATT Semana</th>
                                    <th class="text-900 sort" data-sort="horaAtencionFinsemana">HS ATT Finsemana</th>
                                </tr>
                            </thead>
                            <tbody class="list">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle white-space-nowrap telefono"><?php echo htmlspecialchars($row['telefono']); ?></td>
